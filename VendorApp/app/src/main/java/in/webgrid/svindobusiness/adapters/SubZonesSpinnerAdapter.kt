...
import`in`.webgrid.svindobusiness.modelclass.LocationSubZone

class SubZonesSpinnerAdapter (private val context: Context, private val itemList: List<LocationSubZone>) : BaseAdapter() {
