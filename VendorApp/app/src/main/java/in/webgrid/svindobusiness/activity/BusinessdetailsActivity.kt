...
import`in`.webgrid.svindobusiness.databinding.ActivityBusinessdetailsBinding
import`in`.webgrid.svindobusiness.databinding.ActivityGstinBinding
...
class BusinessdetailsActivity : AppCompatActivity() {
    ...
    private val EmailPattern = "^([\\w.\\-]+)@([\\w\\-]+)((\\.(\\w){2,63}){1,3})\$".toRegex()
